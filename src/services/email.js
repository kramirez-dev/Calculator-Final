...
export default function sendEmail(e) {//Funcion para mandar email
  ...
  const template_params = {
    ...
    "message_html": "In-House US $"+e.target.total.value, //La info de interes sobre el costo
    "message_html2": "Nearshore $"+e.target.total2.value,
    "message_html3": "Offshore $"+e.target.total3.value 
   }
